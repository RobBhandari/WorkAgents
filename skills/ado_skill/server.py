    ...
    return [
        ...
        Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "organization": {"type": "string", "description": "ADO organization name"},
                    "ids": {
                        "type": "array",
                        "items": {"type": "integer"},
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "max_per_definition": {"type": "integer", "description": "Optional limit per pipeline definition"},
                },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "organization": {"type": "string", "description": "ADO organization name"},
                    "project": {"type": "string", "description": "Project name"},
                    "top": {"type": "integer", "description": "Maximum number of runs to retrieve (default: 50)"},
                },
                "required": ["organization", "project"],
            },
        ),
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    if name == "query_work_items":
        result = await query_work_items(
            organization=arguments["organization"], project=arguments["project"], wiql=arguments["wiql"]
        )
    elif name == "get_work_items_by_ids":
        result = await get_work_items_by_ids(
            organization=arguments["organization"], ids=arguments["ids"], fields=arguments.get("fields")
        )
        ...
        result = await get_test_runs(
            organization=arguments["organization"], project=arguments["project"], top=arguments.get("top", 50)
        )
    else:
