    ...
    <body>
        ...
        <div class="card">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 20px 0;">
                <tr>
                    <td width="25%" style="padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; vertical-align: top;">
                        <div style="color: #6c757d; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px;">Baseline</div>
                        <div style="font-size: 36px; font-weight: bold; color: #333;">{baseline_total}</div>
                    </td>
                    <td width="5%"></td>
                    <td width="25%" style="padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; vertical-align: top;">
                        <div style="color: #6c757d; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px;">Current</div>
                        <div style="font-size: 36px; font-weight: bold; color: {status_color};">{current_total}</div>
                    </td>
                    <td width="5%"></td>
                    <td width="25%" style="padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; vertical-align: top;">
                        <div style="color: #6c757d; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px;">Target</div>
                        <div style="font-size: 36px; font-weight: bold; color: #333;">{target_remaining}</div>
                    </td>
                    <td width="5%"></td>
                    <td width="25%" style="padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; vertical-align: top;">
                        <div style="color: #6c757d; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px;">Remaining</div>
                        <div style="font-size: 36px; font-weight: bold; color: #333;">{current_total - target_remaining}</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="card">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 20px 0;">
                <tr>
                    <td width="47.5%" style="padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; vertical-align: top;">
                        <div style="color: #6c757d; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px;">Days Tracking</div>
                        <div style="font-size: 36px; font-weight: bold; color: #333;">{days_tracking}</div>
                    </td>
                    <td width="5%"></td>
                    <td width="47.5%" style="padding: 20px; background: #f8f9fa; border-radius: 8px; text-align: center; vertical-align: top;">
                        <div style="color: #6c757d; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 10px;">Days Remaining</div>
                        <div style="font-size: 36px; font-weight: bold; color: #333;">{days_remaining}</div>
                    </td>
                </tr>
            </table>
        </div>
