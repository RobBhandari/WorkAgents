...
if total_findings > 0:
    ...
    print("[!] No findings returned when filtering by Legal product IDs")
    print("\nThis suggests:")
    print("  1. Legal products may not have HIGH/CRITICAL findings currently")
    print("  2. Product ID filtering might not work in REST API")
    print("  3. Need to try GraphQL findings query instead")
print(f"{'='*70}")
