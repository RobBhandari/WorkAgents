...
def generate_dashboard_launcher(output_path: Path | None = None) -> str:
    ...
    dashboards = [
        ...
        },
        {
            ...
            "icon": "🔒",
            "description": "Code and Cloud vulnerability tracking with drill-down by product",
            "status": None,
            "status_class": "",
        },
        {
            "title": "Security: Infrastructure",
            "filename": "security_infrastructure_dashboard.html",
            "icon": "🛡️",
            "description": "Infrastructure vulnerability tracking (Cortex XDR, Tenable, AppCheck, BitSight)",
            "status": None,
            "status_class": "",
        },
        {
