#!/usr/bin/env python3
"""
Security Dashboard Generator (Legacy Wrapper)
...
Original implementation: 1833 lines
New implementation: ~290 lines (see execution/dashboards/security.py)
...
warnings.warn(
    "\n" + "=" * 70 + "\n"
    "generate_security_dashboard.py is deprecated!\n"
    "\n"
...
try:
    from dashboards.security import generate_security_dashboard as _new_implementation
except ImportError:
...
def main():
    ...
    print("[INFO] Update your code to import from execution.dashboards.security")
    print()
