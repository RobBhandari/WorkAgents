...
if legal_products:
    ...
    print(f">>> The new API key is working correctly!")
else:
    ...
    print(f">>> The new API key has the same scope as the old one")
    print(f"\n>>> ACTION REQUIRED:")
    print(f"    When creating the API key, the 'Account Level Access'")
    print(f"    toggle must be ENABLED to access products across all")
