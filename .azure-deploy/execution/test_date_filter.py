...
for i, test in enumerate(test_cases, 1):
    ...
    request_body = {"severity": ["HIGH", "CRITICAL"], "status": ["Open", "In Progress"], "product": [product_id]}
    ...
    try:
        response = requests.post(f"{base_url}/api/findings", headers=headers, json=request_body, timeout=30)
