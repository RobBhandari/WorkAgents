...
py execution\armorcode_query_vulns.py
if errorlevel 1 (
...
py execution\armorcode_report_to_html.py .tmp\%LATEST_JSON%
if errorlevel 1 (
...
py execution\send_armorcode_report.py .tmp\%LATEST_HTML% --json-summary .tmp\%LATEST_JSON%
if errorlevel 1 (
